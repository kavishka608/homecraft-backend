...
* The original package name 'com.homeservice.homecraft-backend' is invalid and this project uses 'com.homeservice.homecraft_backend' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/4.0.7/reference/web/spring-security.html#web.security.oauth2.client)
